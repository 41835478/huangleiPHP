...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ...
            ['bold', 'italic', 'underline', 'fontborder','fontfamily', 'fontsize',  'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc','justifyleft', 'justifyright','justifycenter','justifyjustify','map','insertimage']
        ]
