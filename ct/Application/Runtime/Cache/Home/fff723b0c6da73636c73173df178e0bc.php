...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/Build/add');?>">添加</a></span>
    <span class="action-span1"><a href="#">创特 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 施工现场列表 </span>
    <div style="clear:both"></div>
</h1>
<form method="post" action="<?php echo U(MODULE_NAME.'/Build/bdel');?>" name="listForm">
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            <tr>
                <th width="40"><input  onclick="t()" id="checkbox" type="checkbox"/></th>
                <th width="100">序号</th>
                <th width="200">施工现场名称</th>
            ...
            <tr>
                ...
                <td align="center"><?php
 foreach($img as $k){ if($k['build_id'] == $v['id']){ echo '<img src= http://localhost/ct/Uploads/'.$k['sm_images'].'>'; echo '&nbsp'; } } ?></td>
                <td align="center">
                    <a href="<?php echo U(MODULE_NAME.'/Build/save',array('id'=>$v['id']));?>" title="编辑">编辑</a>
                    |
                    <a onclick="return confirm('确定要删除吗？');" href="<?php echo U(MODULE_NAME.'/Build/del',array('id'=>$v['id']));?>" title="移除">移除</a>
                </td>
            </tr>
            <?php endforeach;?>
            <tr>
