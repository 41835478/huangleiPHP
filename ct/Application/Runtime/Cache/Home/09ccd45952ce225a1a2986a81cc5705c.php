...
var nav = document.getElementById('nav_20');nav.className=nav.className+" on";
</script>
      <img src="/ct/Public/Yourphp/Tpl/Home/Default/Public/images/banner5.jpg" width="944" height="260" />
      <div class="clear"></div>
    </div>
    <div class="box_b"></div>
  </div>
  ...
  <div class="page_l">
    <div class="box_l">
      ...
      <div class="box_l_m"><p style="color:rgba(121,190,247,1.00); font-size:25px; margin-left:15px;">关于/About</p><img src="/ct/Public/Yourphp/Tpl/Home/Default/Public/images/box_l_line.png" style="margin:10px auto 20px;" />
        <div class="sidebar">
          <div class="sidenav tab"><a title="公司介绍" class="moren">公司介绍</a></div>
          <div class="sidenav tab"><a title="人才招聘">人才招聘</a></div>
        </div>
        <div class="clear"></div>
      </div>
 ...
 <div class="page_r">
    ...
    <div class="box_r">
      <div class="box_r_m" style="background:rgba(255,255,255,0.7); border-radius:15px;width:735px;">
        <div class="box_r_title"><p style="color:rgba(121,190,247,1.00); font-size:25px;">公司介绍/Case Shows</p></div>
        <div class="clear"></div>
      </div>
    </div>
    <div class="box_r">
      <div class="box_r_m">
        ...
        <div style="float:left;line-height:25px;width:734px;margin-left:0px;">
            <?php echo $v['content']?>
        </div>
          <?php endforeach;?>
    ...
    <div class="page_r" style="display:none">
        <div class="box_r">
            <div class="box_r_m" style="background:rgba(255,255,255,0.7); border-radius:15px;width:735px;">
                <div class="box_r_title"><p style="color:rgba(121,190,247,1.00); font-size:25px;">人才招聘/Case Shows</p></div>
                <div class="clear"></div>
            </div>
        </div>
        <div class="box_r">
