...
<h1>
    ...
    <span id="search_id" class="action-span1"> - 添加工程案例 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/Project/add');?>" enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="status" value="是" />是
                    <input type="radio" name="status" value="否" checked="checked"/>否
                </td>
            </tr>
            <tr>
                <td class="label">案例图片</td>
                <td>
                    <input type="file" name="project[]" maxlength="60" value="" /><input onclick="addRow(this);" type="button" value="<?php echo $k0 == 0 ? '+' : '-'; ?>" />
