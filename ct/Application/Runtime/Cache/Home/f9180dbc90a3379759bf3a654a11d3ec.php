...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/Category/lst');?>">列表</a></span>
    <span class="action-span1"><a href="#">创特 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 修改风格 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/Category/save');?>" enctype="multipart/form-data" >
        <input type="hidden" name="id" value="<?php echo $data['id']?>" />
        <table cellspacing="1" cellpadding="3" width="100%">

            <tr>
                <td class="label">风格名称</td>
                <td>
