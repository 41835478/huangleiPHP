...
.explode {
  background:url(/ct/Public/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/ct/Public/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/ct/Public/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/ct/Public/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            家装案例模块
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Home/Category/lst');?>" target="main-frame">案例风格列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('Home/Case/lst');?>" target="main-frame">家装案例列表</a></li>
            ...
            工程案例模块
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Home/Project/lst');?>" target="main-frame">工程案例列表</a></li>
            ...
            <li class="explode" key="08_members" name="menu">
                施工现场模块
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Home/Build/lst');?>" target="main-frame">施工现场列表</a></li>
            ...
            <li class="explode" key="08_members" name="menu">
                关于我们模块
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Home/Company/lst');?>" target="main-frame">公司介绍</a></li>
                    <li class="menu-item"><a href="<?php echo U('Home/Employ/lst');?>" target="main-frame">人才招聘</a></li>
            ...
            <li class="explode" key="08_members" name="menu">
                资讯中心模块
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Home/Active/lst');?>" target="main-frame">资讯列表</a></li>
                </ul>
            </li>
        </ul>
    </div>
...
<script type="text/javascript" src="/ct/Public/Js/global.js"></script>
<script type="text/javascript" src="/ct/Public/Js/utils.js"></script>
<script type="text/javascript" src="/ct/Public/Js/transport.js"></script>
