...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            <?php $menu = $_SESSION['menu']; foreach($menu as $k => $v): ?>
            <li class="explode">
            <?php echo $v['pri_name']?>
                <ul>
        ...
        <!--
            ...
            商品管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Goods/Goods/lst');?>" target="main-frame">商品列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('Goods/Category/lst');?>" target="main-frame">商品分类</a></li>
            ...
            会员管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Member/Member/lst');?>" target="main-frame">会员列表</a></li>
