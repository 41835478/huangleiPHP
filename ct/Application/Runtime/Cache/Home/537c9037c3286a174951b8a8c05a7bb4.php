...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/Build/lst');?>">列表</a></span>
    <span class="action-span1"><a href="#">创特 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 添加施工现场 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/Build/add');?>" enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="file" name="build[]" maxlength="60" value="" /><input onclick="addRow(this);" type="button" value="<?php echo $k0 == 0 ? '+' : '-'; ?>" />
