  ...
  <div class="page_r" style="width:980px;margin-left:0px;">
    <div class="box_r">
      <div class="box_r_m" style="background:rgba(255,255,255,0.7); border-radius:15px;width:945px;height:35px;">
        <div class="box_r_title"><p style="color:rgba(121,190,247,1.00); font-size:18px;"><a href="<?php echo U(MODULE_NAME.'/Index/build');?>">施工现场>>>></a><?php echo $data['name']?></p></div>
      </div>
    </div>
          ...
          <div class="box_r">
              <div class="box_r_m" style="width:960px;">
                  ...
                  <div id="fanye" style="width:900px;height:40px;margin-top:15px;">
                      <?php
 $next = M('build')->where('id>'.$data['id'])->order("id ASC")->limit(1)->select(); $prev = M('build')->where('id<'.$data['id'])->order("id DESC")->limit(1)->select(); ?>
                      <h4 style="float:left;">上一案例: &nbsp;<a href="<?php echo U(MODULE_NAME.'/Index/buildImg',array('id'=>$prev[0]['id']));?>"><?php echo $prev[0]['name']?></a></h4><br />
                      <h4 style="float:left;">下一案例: &nbsp;<a href="<?php echo U(MODULE_NAME.'/Index/buildImg',array('id'=>$next[0]['id']));?>"><?php echo $next[0]['name']?></a></h4>
                  </div>
