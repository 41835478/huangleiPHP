  ...
  <div class="page_r" style="width:980px;margin-left:0px;">
    <div class="box_r">
      <div class="box_r_m" style="background:rgba(255,255,255,0.7); border-radius:15px;width:945px;">
        <div class="box_r_title"><p style="color:rgba(121,190,247,1.00); font-size:25px;">工程案例/Case Shows</p></div>
      </div>
    </div>
    ...
    <div class="box_r mtop10" id="box-mtop10">
        <div class="anli348"  style="background: rgba(255, 255, 255, 0.7);width:200px;height:180px;border-radius: 15px;padding:16px;">
            <div class="anli348_tu">
                <a href="<?php echo U(MODULE_NAME.'/Index/img',array('id'=>$v['id']));?>" target="_self"><img src="/ct/Uploads/<?php foreach($img as $k){ if($k['pro_id'] == $v['id']){ echo $k['big_images']; break; } }?>" width="200" height="148" border="0"></a>
            </div>
