...
<link href="/ct/Public/Styles/main.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript">
        ...
        window.onload = function(){
            ...
            window.UEDITOR_CONFIG.imageUrl = "<?php echo U(MODULE_NAME.'/Employ/upload');?>";
...
<h1>
    ...
    <span id="search_id" class="action-span1"> - 添加人才招聘 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/Employ/add');?>" enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">招聘信息</td>
                <td>
