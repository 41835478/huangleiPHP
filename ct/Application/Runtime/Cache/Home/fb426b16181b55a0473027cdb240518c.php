...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/Category/add');?>">添加</a></span>
    <span class="action-span1"><a href="#">创特 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 案例风格列表 </span>
        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <tr>
                ...
                <td align="center">
                    ...
                    |
                    <a onclick="return confirm('确定要删除吗？');" href="<?php echo U(MODULE_NAME.'/category/del',array('id'=>$v['id']));?>" title="移除">移除</a>
                </td>
            </tr>
            <?php endforeach;?>
            <tr>
