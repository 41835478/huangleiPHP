...
<h1>
    <?php  if(count($data)<1){ ?>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/Employ/add');?>">添加</a></span>
    <?php }?>
    <span class="action-span1"><a href="#">创特 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 人才招聘列表 </span>
    <div style="clear:both"></div>
</h1>
<form method="post" action="<?php echo U(MODULE_NAME.'/Employ/bdel');?>" name="listForm">
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <tr>
                ...
                <td align="center">
                    <a href="<?php echo U(MODULE_NAME.'/Employ/save',array('id'=>$v['id']));?>" title="编辑">编辑</a>
                    |
                    <a onclick="return confirm('确定要删除吗？');" href="<?php echo U(MODULE_NAME.'/Employ/del',array('id'=>$v['id']));?>" title="移除">移除</a>
                </td>
            </tr>
            <?php endforeach;?>
            <tr>
