...
<h1>
    ...
    <span id="search_id" class="action-span1"> - 添加家装案例 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/Case/add');?>" enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="file" name="case[]" maxlength="60" value="" /><input onclick="addRow(this);" type="button" value="<?php echo $k0 == 0 ? '+' : '-'; ?>" />
