...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/putStock/lst');?>">列表</a></span>
    <span class="action-span1"><a href="#">危险化学品 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 入库添加 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/putStock/add');?>" enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="buyer" maxlength="60" value="" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="acceptor" maxlength="60" value="" />
                </td>
            </tr>
            <tr>
