...
.explode {
  background:url(/chem/Public/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/chem/Public/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/chem/Public/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/chem/Public/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
    ...
    <div id="menu-list">
        ...
        <?php if($_SESSION['level'] == 0){?>
            <li class="explode">
                危险化学品模块
                <ul>
                    <li class="menu-item"><a href="/chem/index.php/Home/Goods/lst" target="main-frame">危险品安全信息表</a></li>
                </ul>
            </li>
            <li class="explode">
                库存模块
                <ul>
                    <li class="menu-item"><a href="/chem/index.php/Home/Stock/lst" target="main-frame">危险品库存清单</a></li>
                    <li class="menu-item"><a href="/chem/index.php/Home/PutStock/lst" target="main-frame">入库管理</a></li>
                    <li class="menu-item"><a href="/chem/index.php/Home/OutStock/lst" target="main-frame">出库管理</a></li>
                </ul>
            </li>
            <li class="explode">
                审批结算模块
                <ul>
                    <li class="menu-item"><a href="/chem/index.php/Home/Apply/applst" target="main-frame">待审批列表</a></li>
                    <li class="menu-item"><a href="/chem/index.php/Home/Apply/passlst" target="main-frame">已批准列表</a></li>
                    <li class="menu-item"><a href="/chem/index.php/Home/Apply/clearlst" target="main-frame">结算清单</a></li>
                    <li class="menu-item"><a href="/chem/index.php/Home/Apply/clearlst1" target="main-frame">已结算清单</a></li>
                </ul>
            </li>
            <li class="explode">
                发布信息模块
                <ul>
                    <li class="menu-item"><a href="/chem/index.php/Home/safety/lst" target="main-frame">安全知识</a></li>
                    <li class="menu-item"><a href="/chem/index.php/Home/rules/lst" target="main-frame">规章制度</a></li>
                    <li class="menu-item"><a href="/chem/index.php/Home/notice/lst" target="main-frame">公告</a></li>
                </ul>
            </li>
        <?php }else if($_SESSION['level'] == 1){?>
            <li class="explode">
                危险化学品模块
                <ul>
                    <li class="menu-item"><a href="/chem/index.php/Home/Goods/msg" target="main-frame">危险品安全信息表</a></li>
                </ul>
            </li>
            <li class="explode">
                申领及审批管理
                <ul>
                    <li class="menu-item"><a href="/chem/index.php/Home/Apply/add" target="main-frame">危险品申领</a></li>
                    <li class="menu-item"><a href="/chem/index.php/Home/Apply/lst" target="main-frame">申领进度查询</a></li>
                    <li class="menu-item"><a href="/chem/index.php/Home/Apply/applst" target="main-frame">待审批列表</a></li>
                    <li class="menu-item"><a href="/chem/index.php/Home/Apply/passlst" target="main-frame">已批准列表</a></li>
                </ul>
            </li>
...
<script type="text/javascript" src="/chem/Public/Js/global.js"></script>
<script type="text/javascript" src="/chem/Public/Js/utils.js"></script>
<script type="text/javascript" src="/chem/Public/Js/transport.js"></script>
