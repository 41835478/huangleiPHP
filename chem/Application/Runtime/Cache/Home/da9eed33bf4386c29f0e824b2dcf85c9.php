...
<h1>
    ...
    <span id="search_id" class="action-span1"> - 已批准列表 </span>
...
<form method="post" action="<?php echo U(MODULE_NAME.'/rules/bdel');?>" name="listForm">
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php foreach($data as $v): if($_SESSION['level'] == 2){ if($v['teacher_id'] == $v['uid']){ continue; }else if($v['zhuguan_id'] == $v['uid']){ continue; } } ?>
            <tr>
