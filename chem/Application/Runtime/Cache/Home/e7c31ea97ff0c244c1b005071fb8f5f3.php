...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/safety/lst');?>">列表</a></span>
    <span class="action-span1"><a href="#">危险化学品 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 安全知识添加 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/safety/add');?>" enctype="multipart/form-data" >
