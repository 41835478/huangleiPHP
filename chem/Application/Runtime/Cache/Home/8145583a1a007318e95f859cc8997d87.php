...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="/chem/Public/Images/logo.png" alt="ECSHOP - power for e-commerce" />
    </div>
    <div id="submenu-div">
       <br />
        <div id="send_info">
            <span>欢迎您：<?php echo $_SESSION['username']?></span>
            <a href="<?php echo U(MODULE_NAME.'/Index/index');?>" target="_top" class="fix-submenu">返回首页</a>
            <a href="<?php echo U(MODULE_NAME.'/Login/logout');?>" target="_top" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
    <ul>
        ...
        <li><a href="<?php echo U(MODULE_NAME.'/Back/main');?>" target="main-frame">起始页</a></li>
        <li><a href="<?php echo U(MODULE_NAME.'/Back/sav');?>" target="main-frame">修改密码</a></li>
