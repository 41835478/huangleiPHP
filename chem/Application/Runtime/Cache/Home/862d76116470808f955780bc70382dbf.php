...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/notice/add');?>">添加</a></span>
    <span class="action-span1"><a href="#">危险化学品 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 公告列表 </span>
    <div style="clear:both"></div>
</h1>

<form method="post" action="<?php echo U(MODULE_NAME.'/notice/bdel');?>" name="listForm">
