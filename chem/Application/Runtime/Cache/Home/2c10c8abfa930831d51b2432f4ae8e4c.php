...
<h1>
    ...
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/goods/add');?>">添加</a></span>
...
<form method="post" action="<?php echo U(MODULE_NAME.'/goods/bdel');?>" name="listForm">
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <tr>
                ...
                |
                <a onclick="return confirm('确定要删除吗？');" href="<?php echo U(MODULE_NAME.'/goods/del',array('id'=>$v['id'],'role_id'=>$v['role_id']));?>" title="编辑">移除</a>
                </td>
            </tr>
            <?php endforeach;?>
