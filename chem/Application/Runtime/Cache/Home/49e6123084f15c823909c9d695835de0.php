...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/outStock/add');?>">添加</a></span>
    <span class="action-span1"><a href="#">危险化学品 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 出库列表 </span>
    <div style="clear:both"></div>
</h1>

<form method="post" action="<?php echo U(MODULE_NAME.'/goods/OutStock');?>" name="listForm">
 ...
 foreach($goods as $k){ if($v['stock_id'] == $k['id']){ echo $k['goods_name'].'('.$k['size'].')'; } } ?>
                ...
                <td align="center"><?php echo $v['sybm']?></td>
                <td align="center"><?php echo $v['used']?></td>
                ...
                <td align="center">
                    <a href="<?php echo U(MODULE_NAME.'/outStock/save',array('id'=>$v['id']));?>" title="编辑">编辑</a>
                    |
                    <a onclick="return confirm('确定要删除吗？');" href="<?php echo U(MODULE_NAME.'/outStock/del',array('id'=>$v['id']));?>" title="删除">删除</a>
