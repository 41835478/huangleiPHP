...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <h1 style="color: white">Clothing Shop</h1>
    </div>
    <div id="submenu-div">

        <div id="send_info">
            <a href="<?php echo U('Home/index/index');?>" target="_blank" class="fix-submenu">前往商城</a>
            <a href="<?php echo U('Home/Login/logout');?>" target="_top" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
    <ul>
        ...
        <li><a href="/clothing_shop/index.php/Home/Admin/index" target="main-frame">起始页</a></li>
