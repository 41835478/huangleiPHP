...
<h1>
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php foreach ($actionData as $k => $v): ?>
            <tr>
                <td align="center"><?php echo $v['id']?></td>
                <td align="center"><?php echo $v['username'];?></td>
                <td align="center"><?php echo $v['ip'];?></td>
                <td align="center"><?php echo $v['last_login_time'];?></td>
                <td align="center"><?php echo $v['last_logout_time'];?></td>

                <td align="center">
                    <a onclick="return confirm('确定要删除吗？');" href="<?php echo U(MODULE_NAME.'/action/del',array('id'=>$v['id']));?>" title="编辑">移除</a>
                </td>
            </tr>
           	<?php endforeach; ?>
