...
<head>
<title>Clothing Shop 管理中心</title>
...
.explode {
  background:url(/clothing_shop/Public/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/clothing_shop/Public/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/clothing_shop/Public/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/clothing_shop/Public/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            会员管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Member/lst');?>" target="main-frame">会员列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('Home/Action/lst');?>" target="main-frame">会员行为记录</a></li>
            ...
            <li class="explode" key="08_members" name="menu">
                订单管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Buy/lst');?>" target="main-frame">购买记录</a></li>
            ...
            <li class="explode" key="08_members" name="menu">
                评论管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Message/lst');?>" target="main-frame">评论列表</a></li>
...
<script type="text/javascript" src="/clothing_shop/Public/Js/global.js"></script>
<script type="text/javascript" src="/clothing_shop/Public/Js/utils.js"></script>
<script type="text/javascript" src="/clothing_shop/Public/Js/transport.js"></script>
