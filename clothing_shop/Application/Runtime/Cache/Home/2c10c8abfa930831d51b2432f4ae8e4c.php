...
<div class="form-div">
    <form action="<?php echo U(MODULE_NAME.'/goods/lst');?>" name="searchForm" method="get">
        <img src="/clothing_shop/Public/Images/icon_search.gif" width="26" height="22" border="0" alt="search" />
        <input type="text" name="un" size="15" value="<?php echo $_GET['un']?>" placeholder="输入商品名称关键字"/>
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <tr>
                ...
                <td align="center"><img src="/clothing_shop/Uploads/<?php echo $v['goods_image']; ?>" width="120"></td>
                <td align="center"><?php echo $v['cat_name']?></td>
                <td align="center"><?php echo $v['goods_size']?></td>
                <td align="center"><?php echo $v['goods_price']?>元</td>
                <td align="center"><?php echo $v['goods_info']?></td>
                <td align="center"><?php echo $v['goods_time']?></td>
                <td align="center">
                    <a href="<?php echo U(MODULE_NAME.'/goods/save',array('id'=>$v['id']));?>" title="编辑">编辑</a>
                    <a onclick="return confirm('确定要删除吗？');" href="<?php echo U(MODULE_NAME.'/goods/del',array('id'=>$v['id']));?>" title="编辑">移除</a>
                </td>
            </tr>
           	<?php endforeach; ?>
