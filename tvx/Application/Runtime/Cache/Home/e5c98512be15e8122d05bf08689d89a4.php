...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/record/lst');?>">列表</a></span>
    <span class="action-span1"><a href="#">TVX 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 添加 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/record/add');?>" enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="xj_time" maxlength="60" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">巡检内容</td>
                <td>
                    <input type="text" name="xj_content" maxlength="60" size="40" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">巡检记录</td>
                <td>
                    <input type="text" name="xj_record" maxlength="60" size="40" value="" />
                </td>
            </tr>
