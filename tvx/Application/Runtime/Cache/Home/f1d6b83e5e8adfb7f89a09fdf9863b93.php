...
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/fault/save');?>" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="gz_time" maxlength="60" value="<?php echo $data['gz_time']?>" />
                </td>
            </tr>
            <tr>
                <td class="label">故障处理说明</td>
                <td>
                    <input type="text" name="gz_inc" maxlength="60" size="40" value="<?php echo $data['gz_inc']?>" />
                </td>
            </tr>
            <tr>
                <td class="label">故障内容</td>
                <td>
                    <input type="text" name="gz_content" maxlength="60" size="40" value="<?php echo $data['gz_content']?>" />
                </td>
            </tr>
