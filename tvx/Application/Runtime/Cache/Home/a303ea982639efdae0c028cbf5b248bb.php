...
.explode {
  background:url(/tvx/Public/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/tvx/Public/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/tvx/Public/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/tvx/Public/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
        ...
        <ul id="menu-ul">
            ...
            <li class="explode">
                ...
                <ul>
                    ...
                    <li class="menu-item"><a href="<?php echo U('Home/Category/lst');?>" target="main-frame">角色列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('Home/admin/lst');?>" target="main-frame">管理员列表</a></li>
                    <?php endif;?>
                    <?php if(isset($_SESSION['level']) && $_SESSION['level']!=3):?>
                    <li class="menu-item"><a target="main-frame">角色列表(您无权访问！)</a></li>
                    <li class="menu-item"><a href="<?php echo U('Home/admin/lst');?>" target="main-frame">管理员列表</a></li>
                    <?php endif;?>
                    <?php if(isset($_SESSION['level']) && $_SESSION['level']==3):?>
                    <li class="menu-item"><a target="main-frame">角色列表(您无权访问！)</a></li>
                    <li class="menu-item"><a target="main-frame">管理员列表(您无权访问！)</a></li>
                    <?php endif;?>
            ...
            <li class="explode">
                设备模块
                <ul>
                    <?php if($_SESSION['level']==3 || empty($_SESSION['level'])):?>
                    <li class="menu-item"><a href="<?php echo U(MODULE_NAME.'/Device/lst');?>" target="main-frame">设备列表</a></li>

                    <?php endif;?>
                    <?php if($_SESSION['level']==1 || $_SESSION['level']==2):?>
                    <li class="menu-item"><a target="main-frame">设备列表(您无权访问！)</a></li>
            ...
            <li class="explode">
                ...
                <ul>
                    <?php if($_SESSION['level']==3 || empty($_SESSION['level'])):?>
                    <li class="menu-item"><a href="<?php echo U(MODULE_NAME.'/record/lst');?>" target="main-frame">巡检列表</a></li>
                    <li class="menu-item"><a href="<?php echo U(MODULE_NAME.'/fault/lst');?>" target="main-frame">故障及维修列表</a></li>
                    <?php endif;?>
                    <?php if($_SESSION['level']==1 || $_SESSION['level']==2):?>
                    <li class="menu-item"><a target="main-frame">巡检列表(您无权访问！)</a></li>
                    <li class="menu-item"><a target="main-frame">故障及维修列表(您无权访问！)</a></li>
                    <?php endif;?>
...
<script type="text/javascript" src="/tvx/Public/Js/global.js"></script>
<script type="text/javascript" src="/tvx/Public/Js/utils.js"></script>
<script type="text/javascript" src="/tvx/Public/Js/transport.js"></script>
