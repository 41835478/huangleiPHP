...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/Admin/lst');?>">管理员列表</a></span>
    <span class="action-span1"><a href="#">TVX 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 添加管理员 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/Admin/add');?>" enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="name" maxlength="60" size="40" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">手机号</td>
                <td>
                    <input type="text" name="phone" maxlength="60" size="40" value="" />
                </td>
            </tr>
            <tr>
