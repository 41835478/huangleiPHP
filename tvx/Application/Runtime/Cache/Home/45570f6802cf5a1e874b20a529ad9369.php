...
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/status/add');?>" enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">运行状态名称</td>
                <td>
                    <input type="text" name="sta_name" maxlength="60" value="" />
                    <span style="color:red">* 填填写设备的运行状态名称</span>
                </td>
            </tr>
            <tr>
