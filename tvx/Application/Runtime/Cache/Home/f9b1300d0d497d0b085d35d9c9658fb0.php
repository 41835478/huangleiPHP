...
<body>
<h1>
    <span class="action-span"><a href="<?php echo U(MODULE_NAME.'/record/add');?>">添加</a></span>
    <span class="action-span1"><a href="#">TXV 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 列表 </span>
    <div style="clear:both"></div>
</h1>

<form method="post" action="<?php echo U(MODULE_NAME.'/record/bdel');?>" name="listForm">
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <tr>
                ...
                <td align="center"><?php echo $v['xj_time']?></td>
                <td align="center"><?php echo $v['xj_content']?></td>
                <td align="center"><?php echo $v['xj_record']?></td>
                <td align="center">
                <a href="<?php echo U(MODULE_NAME.'/record/save',array('id'=>$v['id']));?>" title="编辑">编辑</a>
                |
                <a onclick="return confirm('确定要删除吗？');" href="<?php echo U(MODULE_NAME.'/record/del',array('id'=>$v['id'],'role_id'=>$v['role_id']));?>" title="编辑">移除</a>
                </td>
            </tr>
            <?php endforeach;?>
            <tr>
