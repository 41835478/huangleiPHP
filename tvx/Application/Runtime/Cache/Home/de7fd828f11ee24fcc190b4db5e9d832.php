...
<div class="main-div">
    <form method="post" action="<?php echo U(MODULE_NAME.'/device/add');?>" enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">设备序列号</td>
                <td>
                    <input type="text" name="dev_id" maxlength="60" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">设备名称</td>
                <td>
                    <input type="text" name="dev_name" maxlength="60" value="" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="dev_place" maxlength="60" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">电机状态</td>
                <td>
                    <input type="text" name="dev_dj_status" maxlength="60" size="40" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">碳刷状态</td>
                <td>
                    <input type="text" name="dev_ts_status" maxlength="60" size="40" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">清洁面积</td>
                <td>
                    <input type="text" name="qjmj" maxlength="60" size="40" value="" />
                </td>
            </tr>
            <tr>
                <td class="label">机型</td>
                <td>
                    <input type="text" name="dev_num" maxlength="60" size="40" value="" />
                </td>
            </tr>
            <tr>
