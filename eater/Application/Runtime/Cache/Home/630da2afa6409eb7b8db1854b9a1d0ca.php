    ...
    <div class="content mar_20">
        ...
        <div class="warning">
            <table border="0" style="width:1000px; " cellspacing="0" cellpadding="0">
                <tr height="40">
                    <td>
                        <div class="pay_success"><p><img src="/eater/Public/images/success.gif"><span>支付成功</span></p></div>
                    </td>
                </tr>
                <tr height="40">
                    <td style="font-size:18px;">
                        <span>订单号 : </span> <font color="#ff4e00"><?php echo $_GET['ordersn'];?></font>
                    </td>
                </tr>
                <tr height="40">
                    <td style="font-size:18px;">
                        <span>卖家会尽快安排发货，您可在“我的订单”中查看订单，提醒发货，查看物流等</span>
                    </td>
                </tr>
                <tr height="40">
                    <td style="font-size:18px;">
                        <span>--> <a href="<?php echo U('Personal/order',array('status'=>'待发货'));?>" target="_blank" style="text-decoration: underline">我的订单</a> | <a href="<?php echo U('Index/index');?>" style="text-decoration: underline">继续购物</a></span>
                    </td>
                </tr>
