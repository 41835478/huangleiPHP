...
<div class="i_bg">
	<div class="postion" style="height:32px;">
        <?php if(isset($_GET['brand_id']) || isset($_GET['cat_id']) || isset($_GET['type_id'])){ ?>
            ...
            <span class="n_ch">
                ...
                <a href="<?php echo U('Index/search',getParameter('brand_id','',false));?>"><img src="/eater/Public/images/s_close.gif" /></a>
            </span>
            <?php } ?>
            ...
            <span class="n_ch">
                ...
                <a href="<?php echo U('Index/search',getParameter('type_id','',false));?>"><img src="/eater/Public/images/s_close.gif" /></a>
            </span>
            <?php }?>
            ...
            <span class="n_ch">
                ...
                <a href="<?php echo U('Index/search',getParameter('cat_id','',false)); ?>"><img src="/eater/Public/images/s_close.gif" /></a>
            </span>
            <?php }?>
        &nbsp;<a href="<?php echo U('Index/search',array('content'=>$_GET['content'],'gid'=>$_GET['gid']));?>">清除筛选</a>
        <?php }?>
    </div>
    <!--Begin 筛选条件 Begin-->
    <div class="content mar_10">
    	<table border="0" class="choice" style="width:100%; font-family:'宋体'; margin:0 auto;" cellspacing="0" cellpadding="0">
          <tr valign="top">
            <td width="70">&nbsp; 品牌：</td>
            <td class="td_a">
                <!--<a href="<?php echo U('Index/search',array('type_id'=>$_GET['type_id'],'cat_id'=>$_GET['cat_id'],'content'=>$_GET['content'],'gid'=>$_GET['gid']));?>" <?php echo !isset($_GET['brand_id'])||$_GET['brand_id'] =="" ? 'class="now"' : '';?>>全部</a>-->
                <?php foreach($brand as $k => $v): ?>
                    <a href="<?php echo U('Index/search',getParameter('brand_id',$v[id]));?>" <?php echo $_GET['brand_id'] == $v['id'] ? 'class="now"' : '';?>><?php echo $v['brand_name'];?></a>
                <?php endforeach; ?>
            </td>
          </tr>
          ...
          <tr>
            <td>&nbsp; 类型：</td>
            <td class="td_a">
                <!--<a href="<?php echo U('Index/search',array('brand_id'=>$_GET['brand_id'],'content'=>$_GET['content'],'gid'=>$_GET['gid'],'cat_id'=>$_GET['cat_id']));?>" <?php echo !isset($_GET['type_id'])||$_GET['type_id'] =="" ? 'class="now"' : '';?>>全部</a>-->
                <?php foreach($type as $k => $v): ?>
                    <a href="<?php echo U('Index/search',getParameter('type_id',$v[id]));?>" <?php echo $_GET['type_id'] == $v['id'] ? 'class="now"' : '';?>><?php echo $v['type_name'];?></a>
                <?php endforeach; ?>
            </td>
          </tr>                                          
          <tr>
            <td>&nbsp; 分类：</td>
            <td class="td_a">
                <!--<a href="<?php echo U('Index/search',array('type_id'=>$_GET['type_id'],'brand_id'=>$_GET['brand_id'],'content'=>$_GET['content'],'gid'=>$_GET['gid']));?>" <?php echo !isset($_GET['cat_id'])||$_GET['cat_id'] =="" ? 'class="now"' : '';?>>全部</a>-->
                <?php foreach($category as $k => $v): ?>
                    <a href="<?php echo U('Index/search',getParameter('cat_id',$v[id]));?>" <?php echo $_GET['cat_id'] == $v['id'] ? 'class="now"' : '';?>><?php echo $v['cat_name'];?></a>
                <?php endforeach; ?>
            </td>
          </tr>                                                             
        </table>                                                                                 
    	...
    	<div class="l_history">
        	...
        	<ul>
            	...
            	<li>
                	...
                	<div class="name"><a href="/eater/index.php/Home/Index/item/id/<?php echo $v['id'];?>"><?php echo $v['goods_jl_title'];?></a></div>
                    <div class="price">
        ...
        <div class="l_list">
        	<div class="list_t">
            	<span class="fl list_or">
                    <a href="<?php echo U('Index/search',getParameter('order','',false));?>" <?php echo !$_GET['order'] ? 'class="now"' : '';?>>全部</a>
 ...
 if($_GET['order'] == 'price_low'){ echo '价格从低到高'; }elseif($_GET['order'] == 'price_up'){ echo '价格从高到低'; }else{ echo '价格'; } ?>
                    ...
                    <a href="<?php echo U('Index/search',getParameter('order','new'));?>" <?php echo $_GET['order']=='new' ? 'class="now"' : '';?>>新品</a>
                </span>
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                	...
                	<li style="height:380px;">
                    	<div class="img"><a href="/eater/index.php/Home/Index/item/id/<?php echo $v['id'];?>" target="_blank"><img src="<?php echo IMG_URL.$v['goods_logo_url'];?>" width="210" height="185" /></a></div>
                        <div class="price">
                        ...
                        <div class="name" style="height:60px;line-height: 20px;font-size: 12px;"><a href="/eater/index.php/Home/Index/item/id/<?php echo $v['id'];?>" target="_blank"><?php echo $v['goods_title'];?></a></div>
                        <div style="height:25px;width:208px;font-size:14px;">  <a href="/eater/index.php/Home/Index/store/store_id/<?php echo $v['store_id'];?>" style="color:#888;text-decoration: underline" target="_blank"><?php echo $v['store_name'];?></a></div>
                        <div class="carbg" style="margin-top:15px;">
                            <a href="#" <?php echo strpos(','.$follow.',',','.$v['id'].',') !== false ? "style='background-image:url(/eater/Public/images/heart_h.png);'":'';?> class="ss heart"  onclick="ajaxFollow(this,'<?php echo $v[id];?>','<?php echo $_SESSION[eater_uid];?>','商品')">
